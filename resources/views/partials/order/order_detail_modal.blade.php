            ...
            <div class="status p-3">
              <table class="table table-borderless">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <div class="heading d-block" id="heading-couponUsed">coupon</div>
                      <div class="subheadings mb-2" style="text-transform: lowercase;" id="content-couponUsed">
                        <!-- content coupon -->
                      </div>
                    </td>
                    <td>
